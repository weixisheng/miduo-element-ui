...
<script type="text/babel">
  import { getRangeHours, getRangeMinutes, modifyTime } from 'miduo-element-ui/src/utils/date-util';
  import ElScrollbar from 'miduo-element-ui/packages/scrollbar';
  import RepeatClick from 'miduo-element-ui/src/directives/repeat-click';
