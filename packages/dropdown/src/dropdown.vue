<script>
  ...
  import ElButton from 'miduo-element-ui/packages/button';
  import ElButtonGroup from 'miduo-element-ui/packages/button-group';
  import { generateId } from 'miduo-element-ui/src/utils/util';
